...
import 'package:weather_app/Portfolio/utils/about_utils.dart';
import 'package:weather_app/Portfolio/utils/utils.dart';
import 'package:weather_app/Portfolio/utils/work_utils.dart';
import 'package:weather_app/Portfolio/widget/about_me_data.dart';
import 'package:weather_app/Portfolio/widget/community_button.dart';
import 'package:weather_app/Portfolio/widget/custom_text_heading.dart';
import 'package:weather_app/Portfolio/widget/tech_widget.dart';
            ...
            children: [
              Column(
                ...
                children: const [
                  AboutMeData(
                    data: "Name",
                    information: "Md. Mashrur Tanvir Nasif",
                  ),
                  AboutMeData(
                    data: "Age",
                    information: "23",
              ...
              Column(
                ...
                children: const [
                  AboutMeData(
                    data: "Email",
                    information: "mashrur15-14720@diu.edu.bd",
                  ),
                  AboutMeData(
                    data: "From",
                    information: "Dhanmondi-32, Dhaka, Bangladesh",
                  ),
                ],
              ),
            ],
